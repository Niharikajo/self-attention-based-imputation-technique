...
•	Select a model and Train it (:pushpin: Change the [`[file_path]#L93`](https://github.com/Niharikajo/self-attention-based-imputation-technique/blob/main/configs/Battery_SAITS_best.ini) , `[dataset]` as it is on your personal computer in </br> :file_folder: `cofigs/Battery_SAITS_best.ini#L1`).  </br>
